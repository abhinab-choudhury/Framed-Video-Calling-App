          ...
          <li className="pr-3">
            <a href="https://www.instagram.com/abhinab_choudhury_/">
              <img
                width="32"
                height="32"
                src="https://img.icons8.com/ios/100/228BE6/instagram-new--v1.png"
          ...
          <li className="mx-3">
            <a href="https://twitter.com/abhinabc_">
              <img
                width="32"
                height="32"
                src="https://img.icons8.com/ios-glyphs/100/228BE6/twitterx--v2.png"
                alt="twitterx--v2"
              />
            </a>
          </li>
      ...
      <div className="font-bold flex flex-col justify-center">
        <div className="flex justify-end">
          ...
          <img
            width="40"
            height="40"
            src="https://img.icons8.com/avantgarde/100/video-message.png"
            alt="video-message"
          />
        </div>
