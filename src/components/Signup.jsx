...
function Signup() {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 '>
      ...
      <h1 className='text-2xl font-bold mr-auto mb-4'> Sign-in </h1>
        ...
        <button className='focus:border-none border-none bg-blue-500 hover:bg-blue-700 w-fit px-3 py-2 rounded text-white font-bold poppins-bold' type='submit'>Sign-in</button>
        ...
        <div>
          <p className="font-extralight">Already had an account than <Link to="/framed/signin" className="text-blue-500 hover:underline"> signin </Link> </p>
        </div>
      </form>
    </div>
  )
